...
//priority queue for parsing route
...
// typedef  pair<int, long double> psd;
// map <int, priority_queue<psd , vector<psd>, greater<psd>> > mp;
// // map <int, vector<pair<int, long double> > > mp;
// int main() {
//     //map <string, vector<pair<string, double> > > mp;
//   // map <int, vector<pair<int, double> > > mp;
...
//          // mp[depart].push_back({destination, 0});
//         if(depart_id != -1 && destination_id != -1){
//     mp[depart_id].push({destination_id,distance(0,0,0,0)});
//         }
